...
import ToyBrick from 'lucide-react-native/icons/toy-brick';
...
/**
 * One icon set for the whole app (Lucide: neutral line icons, drawn with
 * react-native-svg so they stay crisp at any size and never get clipped like
 * emoji glyphs). Screens ask for a meaning, not a glyph.
 */
const ICONS = {
  // navigation & chrome
  home: Home,
...
export function Icon({
  ...
  color?: string;
  strokeWidth?: number;
  /** Solid icons, e.g. a filled star for ratings and favourites. */
  fill?: string;
}) {
