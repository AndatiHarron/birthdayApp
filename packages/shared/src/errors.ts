...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  PAYOUT_TOO_SMALL: 'That is below the smallest amount you can withdraw.',
  PAYOUT_NOT_PENDING: 'That withdrawal has already been dealt with.',
  PAYOUT_DESTINATION_UNVERIFIED: 'Verify your phone number before withdrawing to it.',
...
export const ERROR_STATUS: Record<ErrorCode, number> = {
  ...
  PAYOUT_TOO_SMALL: 422,
  PAYOUT_NOT_PENDING: 409,
  PAYOUT_DESTINATION_UNVERIFIED: 403,
